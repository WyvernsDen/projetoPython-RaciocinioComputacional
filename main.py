...
def op_menu(main_choice):
    while True:
        ...
        if op_choice == 'c' and main_choice == '1':
            incluir_estudantes(main_choice)
            break
        elif op_choice == 'l' and main_choice == '1':
            listar_estudantes(main_choice)
            break
        elif op_choice == 'u' and main_choice == '1':
            modificar_estudantes(main_choice)
            break
        elif op_choice == 'd' and main_choice == '1':
            excluir_estudantes(main_choice)
            break
        elif op_choice == 'q':
            print(Menu.main)
            main_menu()
...
def incluir_estudantes(main_choice):
    ...
    # FIX THIS: creating the methods broke the check for similar students
    else:
        codigo_igual = False
        nome_igual = False
        cpf_igual = False
...
def listar_estudantes(main_choice):
    if len(lista_estudantes) == 0:
        print("\nComando indisponível: Nenhum(a) estudante foi encontrado(a).")
    else:
    # FIX THIS: order the list instead of just printing it
...
def modificar_estudantes(main_choice):
    if len(lista_estudantes) == 0:
        print("\nComando indisponível: Nenhum(a) estudante foi encontrado(a).")
...
def excluir_estudantes(main_choice):
    if len(lista_estudantes) == 0:
        print("\nComando indisponível: Nenhum(a) estudante foi encontrado(a).")
    else:
